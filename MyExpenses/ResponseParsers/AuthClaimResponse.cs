...
namespace MyExpenses.ResponseParsers.AuthClaims
{
    ...
    public class AuthClaimHeadersDT
    {
    ...
    public class ClaimHeaders
    {
        ...
        public List<AuthClaimHeadersDT> AuthClaimHeadersDT { get; set; }
    }
    ...
    public class Diffgram
    {
        ...
        [XmlElement(ElementName = "ClaimLocations")]
        public ClaimLocations ClaimLocations { get; set; }
    }
    ...
    public class AuthClaimDetailsDT
    {
        ...
        [XmlElement(ElementName = "validation_count")]
        public string Validation_count { get; set; }
        [XmlElement(ElementName = "attachment_count")]
        ...
        [XmlElement(ElementName = "assigned_levelID")]
        public string Assigned_levelID { get; set; }
    ...
    public class ClaimDetails
    {
        ...
        public List<AuthClaimDetailsDT> AuthClaimDetailsDT { get; set; }
    }
    ...
    [XmlRoot(ElementName = "ClaimLocationsDT")]
    public class ClaimLocationsDT
    {
        ...
        [XmlElement(ElementName = "journeytime")]
        public string Journeytime { get; set; }
        [XmlElement(ElementName = "trust_regular")]
        public string Trust_regular { get; set; }
        [XmlElement(ElementName = "regular_name")]
        public string Regular_name { get; set; }
        [XmlElement(ElementName = "route_taken")]
        public string Route_taken { get; set; }
        [XmlElement(ElementName = "reference")]
        public string Reference { get; set; }
        [XmlElement(ElementName = "calculation_method")]
        public string Calculation_method { get; set; }
        [XmlElement(ElementName = "deleted")]
        public string Deleted { get; set; }
        [XmlElement(ElementName = "t_last_modified")]
        public string T_last_modified { get; set; }
        [XmlElement(ElementName = "miles")]
        public string Miles { get; set; }
        [XmlElement(ElementName = "location_type")]
        public string Location_type { get; set; }
    }

    [XmlRoot(ElementName = "ClaimLocations")]
    public class ClaimLocations
    {
        [XmlElement(ElementName = "ClaimLocationsDT")]
        public List<ClaimLocationsDT> ClaimLocationsDT { get; set; }
    }
    ...
    [XmlRoot(ElementName = "GetFullClaimLinesAuthResult")]
    public class GetFullClaimLinesAuthResult
    {
    ...
    [XmlRoot(ElementName = "GetFullClaimLinesAuthResponse")]
    public class GetFullClaimLinesAuthResponse
    {
        [XmlElement(ElementName = "GetFullClaimLinesAuthResult")]
        public GetFullClaimLinesAuthResult GetFullClaimLinesAuthResult { get; set; }
    }

    [XmlRoot(ElementName = "Body")]
    public class Body
    {
        [XmlElement(ElementName = "GetFullClaimLinesAuthResponse")]
        public GetFullClaimLinesAuthResponse GetFullClaimLinesAuthResponse { get; set; }
    }
